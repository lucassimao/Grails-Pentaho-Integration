            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="pessoa.tipoPessoa.label" default="Tipo Pessoa" /></td>
                            
                            <td valign="top" class="value">${pessoaInstance?.tipoPessoa?.encodeAsHTML()}</td>
